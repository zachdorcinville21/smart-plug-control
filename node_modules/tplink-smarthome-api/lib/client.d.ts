...
export declare type AnyDevice = Bulb | Plug;
declare type DeviceDiscovery = {
    status: string;
    seenOnDiscovery: number;
};
declare type AnyDeviceDiscovery = (Bulb | Plug) & Partial<DeviceDiscovery>;
declare type AnyDeviceOptionsCon = MarkOptional<ConstructorParameters<typeof Plug>[0], 'client' | 'sysInfo'> | MarkOptional<ConstructorParameters<typeof Bulb>[0], 'client' | 'sysInfo'>;
declare type DeviceOptionsDiscovery = MarkOptional<ConstructorParameters<typeof Plug>[0], 'client' | 'sysInfo' | 'host'> | MarkOptional<ConstructorParameters<typeof Bulb>[0], 'client' | 'sysInfo' | 'host'>;
export declare type DiscoveryDevice = {
    host: string;
    port?: number;
};
...
export interface ClientEventEmitter {
     ...
     */
    on(event: 'device-new', listener: (device: Device | Bulb | Plug) => void): this;
    /**
     * Follow up response from device.
     */
    on(event: 'device-online', listener: (device: Device | Bulb | Plug) => void): this;
    /**
     * No response from device.
     */
    on(event: 'device-offline', listener: (device: Device | Bulb | Plug) => void): this;
    /**
     ...
     */
    on(event: 'discovery-invalid', listener: ({ rinfo, response, decryptedResponse, }: {
        rinfo: RemoteInfo;
        response: Buffer;
    ...
    emit(event: 'discovery-invalid', { rinfo, response, decryptedResponse, }: {
        rinfo: RemoteInfo;
        response: Buffer;
        decryptedResponse: Buffer;
    }): boolean;
