...
import type { CommonSysinfo, DeviceConstructorOptions, Sysinfo } from '../device';
...
declare type PlugChild = {
    id: string;
    alias: string;
    state: number;
};
declare type SysinfoChildren = {
    children?: [{
        id: string;
        alias: string;
        state: number;
...
export declare type PlugSysinfo = CommonSysinfo & SysinfoChildren & ({
