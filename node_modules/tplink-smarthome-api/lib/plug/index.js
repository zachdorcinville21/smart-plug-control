...
var _Plug_children, _Plug_child, _Plug_childId;
...
function hasSysinfoChildren(candidate) {
    return ((0, utils_1.isObjectLike)(candidate) &&
        ...
        (0, utils_1.isObjectLike)(candidate.children) &&
...
class Plug extends device_1.default {
    ...
    constructor(options) {
        ...
        _Plug_children.set(this, new Map());
        _Plug_child.set(this, void 0);
        _Plug_childId.set(this, void 0);
         ...
         */
        this.away = new away_1.default(this, 'anti_theft', __classPrivateFieldGet(this, _Plug_childId, "f"));
        /**
         ...
         */
        this.emeter = new emeter_1.default(this, 'emeter', __classPrivateFieldGet(this, _Plug_childId, "f"));
        /**
         ...
         */
        this.schedule = new schedule_1.default(this, 'schedule', __classPrivateFieldGet(this, _Plug_childId, "f"));
        /**
         ...
         */
        this.timer = new timer_1.default(this, 'count_down', __classPrivateFieldGet(this, _Plug_childId, "f"));
     ...
     */
    get children() {
        return __classPrivateFieldGet(this, _Plug_children, "f");
    }
    setChildren(children) {
        if (Array.isArray(children)) {
            __classPrivateFieldSet(this, _Plug_children, new Map(children.map((child) => {
            ...
            __classPrivateFieldSet(this, _Plug_children, children, "f");
        }
        if (__classPrivateFieldGet(this, _Plug_childId, "f") && __classPrivateFieldGet(this, _Plug_children, "f")) {
            if (__classPrivateFieldGet(this, _Plug_childId, "f") !== undefined)
                this.setChildId(__classPrivateFieldGet(this, _Plug_childId, "f"));
        }
    }
    /**
     * Returns childId.
     */
    get childId() {
        return __classPrivateFieldGet(this, _Plug_childId, "f");
    }
    setChildId(childId) {
        __classPrivateFieldSet(this, _Plug_childId, this.normalizeChildId(childId), "f");
        if (__classPrivateFieldGet(this, _Plug_childId, "f") && __classPrivateFieldGet(this, _Plug_children, "f")) {
            __classPrivateFieldSet(this, _Plug_child, __classPrivateFieldGet(this, _Plug_children, "f").get(__classPrivateFieldGet(this, _Plug_childId, "f")), "f");
        }
        if (__classPrivateFieldGet(this, _Plug_childId, "f") && __classPrivateFieldGet(this, _Plug_child, "f") == null) {
     ...
     */
    get alias() {
        if (__classPrivateFieldGet(this, _Plug_childId, "f") && __classPrivateFieldGet(this, _Plug_child, "f") !== undefined) {
            return __classPrivateFieldGet(this, _Plug_child, "f").alias;
        }
    ...
    setAliasProperty(alias) {
        if (__classPrivateFieldGet(this, _Plug_childId, "f") && __classPrivateFieldGet(this, _Plug_child, "f") !== undefined) {
            __classPrivateFieldGet(this, _Plug_child, "f").alias = alias;
        }
    ...
    get relayState() {
        if (__classPrivateFieldGet(this, _Plug_childId, "f") && __classPrivateFieldGet(this, _Plug_child, "f") !== undefined) {
            return __classPrivateFieldGet(this, _Plug_child, "f").state === 1;
        }
        if (__classPrivateFieldGet(this, _Plug_children, "f") && __classPrivateFieldGet(this, _Plug_children, "f").size > 0) {
            return (Array.from(__classPrivateFieldGet(this, _Plug_children, "f").values()).findIndex((child) => {
    ...
    setRelayState(relayState) {
        if (__classPrivateFieldGet(this, _Plug_childId, "f") && __classPrivateFieldGet(this, _Plug_child, "f") !== undefined) {
            __classPrivateFieldGet(this, _Plug_child, "f").state = relayState ? 1 : 0;
            return;
        }
        if (__classPrivateFieldGet(this, _Plug_children, "f") && __classPrivateFieldGet(this, _Plug_children, "f").size > 0) {
            for (const child of __classPrivateFieldGet(this, _Plug_children, "f").values()) {
    ...
    async getInfo(sendOptions) {
        ...
        let data;
        try {
            data = await this.sendCommand('{"emeter":{"get_realtime":{}},"schedule":{"get_next_action":{}},"system":{"get_sysinfo":{}},"cnCloud":{"get_info":{}}}', __classPrivateFieldGet(this, _Plug_childId, "f"), sendOptionsForGetInfo);
        }
        catch (err) {
    ...
    async setPowerState(value, sendOptions) {
        await this.sendCommand(`{"system":{"set_relay_state":{"state":${value ? 1 : 0}}}}`, __classPrivateFieldGet(this, _Plug_childId, "f"), sendOptions);
...
_Plug_children = new WeakMap(), _Plug_child = new WeakMap(), _Plug_childId = new WeakMap();
